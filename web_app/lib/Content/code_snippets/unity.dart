...
class UnitySnippets {
  ...
  RichText Function(double fontSize) attack = Attack;
  RichText Function(double fontSize) getDamage = GetDamage;
  RichText Function(double fontSize) roomSpawning = RoomSpawning;
}

RichText Attack(double fontSize) {
  return RichText(
    text: TextSpan(
      style: TextStyle(
        fontFamily: 'monospace',
        fontSize: fontSize,
        color: Color(0xFFD4D4D4), // Default light gray (VS Code style)
      ),
      children: [
        // Method declaration
        TextSpan(
        ...
        // else if SpriteDirection == Vector2.down
        TextSpan(text: '  '),
        TextSpan(
          text: 'else if ',
          style: TextStyle(color: Color(0xFF569CD6)),
...
RichText GetDamage(double fontSize) {
  return RichText(
    text: TextSpan(
      style: TextStyle(
        fontFamily: 'monospace',
...
RichText RoomSpawning(double fontSize) {
  return RichText(
    text: TextSpan(
      style: TextStyle(
        fontFamily: 'monospace',
